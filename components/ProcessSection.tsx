...
export default function ProcessSection({ onBookingClick }: ProcessSectionProps) {
  const steps = [
    {
      number: '01',
      title: 'Consultation',
      description: 'Thorough assessment of your concerns, skin quality, and goals',
      icon: '💬',
      duration: '30 mins'
    },
    {
      number: '02',
      title: 'Treatment Day',
      description: 'Local anaesthetic applied, then the Endolift procedure',
      icon: '✨',
      duration: '1 hour'
    },
    {
      number: '03',
      title: 'Recovery',
      description: 'Mild swelling for 1-2 days, back to normal quickly',
      icon: '🏠',
      duration: '1-2 days'
    },
    {
      number: '04',
      title: 'Results Develop',
      description: 'Immediate tightening with continued improvement',
      icon: '📈',
      duration: '3-6 months'
    }
  ]
  ...
  return (
    <section id="how-it-works" className="py-12 sm:py-16 md:py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto section-padding relative z-10">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          <span className="text-primary-600 font-medium tracking-wider uppercase text-xs sm:text-sm">The Process</span>
          ...
          <p className="text-sm sm:text-base lg:text-lg text-neutral-600 mt-2 sm:mt-4 max-w-2xl mx-auto px-4">
            A simple, straightforward process with minimal disruption to your life
          </p>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 items-center">
            <div>
              <div className="bg-gradient-to-r from-primary-100 to-primary-50 rounded-xl p-4 mb-4">
                <div className="flex items-center mb-2">
                  ...
                  <h4 className="font-bold text-primary-800">The Science Behind Endolift</h4>
                </div>
                <p className="text-sm text-primary-700">A hair-thin laser fibre (0.2-0.4mm) delivers 1470nm energy to the subdermal layer, targeting water and fat for immediate contraction plus long-term collagen stimulation.</p>
              </div>
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-xs sm:text-sm lg:text-base text-neutral-700">Local anaesthetic applied for complete comfort</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary-500 mr-2 sm:mr-3 mt-0.5 sm:mt-1">✓</span>
                  <span className="text-xs sm:text-sm lg:text-base text-neutral-700">Tiny entry point (no incisions or scars)</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary-500 mr-2 sm:mr-3 mt-0.5 sm:mt-1">✓</span>
                  <span className="text-xs sm:text-sm lg:text-base text-neutral-700">Laser fibre inserted and moved through treatment area</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary-500 mr-2 sm:mr-3 mt-0.5 sm:mt-1">✓</span>
                  <span className="text-xs sm:text-sm lg:text-base text-neutral-700">Immediate tightening visible, continued improvement over months</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-premium mt-4 lg:mt-0">
              <div className="flex items-center mb-3 sm:mb-4">
                ...
                <div>
                  <h4 className="font-bold text-sm sm:text-base">Honest Advice</h4>
                  <p className="text-xs sm:text-sm text-neutral-600">We'll tell you if Endolift is right for you</p>
                </div>
              </div>
              <p className="text-xs sm:text-sm lg:text-base text-neutral-700 mb-3 sm:mb-4">
                Not everyone is suitable for Endolift. During your consultation, we'll honestly assess whether this treatment will achieve your goals — and recommend alternatives if another option would serve you better.
              </p>
