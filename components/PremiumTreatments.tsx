    ...
    <section id="treatments" className="py-12 sm:py-16 md:py-24 bg-gradient-to-b from-primary-50 to-white">
      <div className="max-w-7xl mx-auto section-padding">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16 space-y-2 sm:space-y-4">
          <span className="text-primary-600 font-medium tracking-wider uppercase text-xs sm:text-sm">Treatment Options</span>
          ...
          <p className="text-sm sm:text-base lg:text-lg text-neutral-600 max-w-2xl mx-auto px-4">
            Choose the treatment area that matches your concerns
          </p>
        </div>
            ...
            >
              {treatment.badge && (
                <div className={`absolute -top-2 sm:-top-3 left-1/2 -translate-x-1/2 ${
                  treatment.badge === 'MOST POPULAR' ? 'bg-gradient-to-r from-primary-500 to-primary-600' : 'bg-gradient-to-r from-purple-500 to-purple-600'
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center gap-6 flex-wrap justify-center text-sm text-neutral-600">
