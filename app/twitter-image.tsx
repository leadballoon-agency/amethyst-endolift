    ...
    (
      ...
      >
        ...
        >
          ...
          >
            <span style={{ color: 'white', fontSize: 40, fontWeight: 800 }}>From £450</span>
            <span style={{ color: 'rgba(255, 255, 255, 0.9)', fontSize: 16 }}>Eyes, Face & Neck</span>
          </div>
          ...
          >
            <span style={{ color: 'white', fontSize: 40, fontWeight: 800 }}>Minimal</span>
          ...
          >
            <span style={{ color: 'white', fontSize: 40, fontWeight: 800 }}>Up to 5 Yrs</span>
