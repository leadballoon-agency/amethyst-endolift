...
export const metadata = {
  ...
  description: 'Privacy Policy for Amethyst Aesthetics Beauty Endolift Treatments in Somerset',
}
        ...
        <div className="prose prose-neutral max-w-none space-y-8">
          <section>
            ...
            <p className="text-neutral-700 leading-relaxed">
              Amethyst Aesthetics Beauty ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website endoliftsomerset.co.uk and use our services.
            </p>
          </section>
